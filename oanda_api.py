...
class OandaAPIForFront():
    ...
    def fetch_candles(self, pair_name, count=100, granularity="H1"):
        ...
        return response.status_code, OandaAPIForFront.candles_to_df(json_data)
...
class OandaAPIForBot():
    ...
    def fetch_candles(self, pair_name, count=10, granularity="H1"):
        ...
        return status_code, OandaAPIForBot.candles_to_df(data['candles'])
